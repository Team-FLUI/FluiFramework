    ...
    public sealed class FluiFrameworkThemeResources : ResourceDictionary
    {
        public FluiFrameworkThemeResources()
        {
            ...
            if (ApiInformation.IsApiContractPresent("Windows.Foundation.UniversalApiContract", 7))  // Minimal 1809
            {
                ...
                this.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("ms-appx:///FluiFramework.UWP.Core/Styles/Button1809.xaml") });
            ...
            {
                this.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("ms-appx:///FluiFramework.UWP.Core/Styles/Button.xaml") });
            ...
            // Regular Styles
            this.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("ms-appx:///FluiFramework.UWP.Core/Styles/_Colours.xaml") });
